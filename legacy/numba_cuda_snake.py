...
def run_simulation(n_snakes, grid_size, n_steps, random_move_prob=0.5, rendering=True):
...
if __name__ == "__main__":
        # Параметры симуляции
    n_snakes = 100  # Количество змеек
    grid_size = 32   # Размер игрового поля
    n_steps = 500    # Количество шагов симуляции
    random_move_prob = 0.2  # Вероятность случайного изменения направления
