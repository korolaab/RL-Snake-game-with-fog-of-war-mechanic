...
runs = {
    ...
    "2 snakes (128-64)": (os.path.join(base, "88d3daa6c41e413aadda814c0ff68b92/metrics"), "purple", "plum"),
}
...
fig.suptitle("Network size comparison — 2 snakes, hunger=88, 3000 episodes", fontsize=14, fontweight='bold')
...
plt.tight_layout()
out = "/home/korolaab/projects/snake_rl/services/net_sizes_comparison.png"
