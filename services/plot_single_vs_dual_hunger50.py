...
runs = {
    "1 snake": (os.path.join(base, "276bb0dd4c6d425dad7033f0dd9f5141/metrics"), "green", "lightgreen"),
    "2 snakes talk": (os.path.join(base, "feb8c762750241d8a491258b5c6ecca8/metrics"), "blue", "lightblue"),
    "2 snakes no talk": (os.path.join(base, "5dd91659d84d4614a42706ec179802cd/metrics"), "red", "lightsalmon"),
}
...
fig.suptitle("1 Snake vs 2 Snakes — max_hunger_steps=50, 3000 episodes", fontsize=14, fontweight='bold')
...
plt.tight_layout()
out = "/home/korolaab/projects/snake_rl/services/single_vs_dual_hunger50.png"
