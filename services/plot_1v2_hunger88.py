...
runs = {
    "1 snake": (os.path.join(base, "eec3a80407b1453d84cbe083340ad4c5/metrics"), "green", "lightgreen"),
    "2 snakes talk": (os.path.join(base, "01035e22efc44b91bc9263d9c9ec70c9/metrics"), "blue", "lightblue"),
}
...
fig.suptitle("1 Snake vs 2 Snakes — max_hunger_steps=88, 3000 episodes", fontsize=14, fontweight='bold')
...
plt.tight_layout()
out = "/home/korolaab/projects/snake_rl/services/1v2_hunger88.png"
